...
dirSwitch?.addEventListener("change", (e) => {
    ...
    if (checkbox.checked) {
        ...
        rtlLink.href = "/static/main/assets/css/vendors/bootstrap.rtl.css";
        localStorage.setItem("rtlcss", "/static/main/assets/css/vendors/bootstrap.rtl.css");
        localStorage.setItem("dir", "rtl");
    }

    if (!checkbox.checked) {
        htmlDom.setAttribute("dir", "ltr");
        rtlLink.href = "/static/main/assets/css/vendors/bootstrap.css";
        localStorage.setItem("rtlcss", "/static/main/assets/css/vendors/bootstrap.css");
        localStorage.setItem("dir", "ltr");
    }
});
// Rtl
htmlDom.setAttribute("dir", localStorage.getItem("dir")?localStorage.getItem("dir") : "ltr");
rtlLink.href = localStorage.getItem("rtlcss")?localStorage.getItem("rtlcss") : "/static/main/assets/css/vendors/bootstrap.css";
